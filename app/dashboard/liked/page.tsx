...
import { ArrowLeft, Heart, Clock, ImageOff, X } from 'lucide-react';
...
export default function LikedAuctionsPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Auctions you've liked</p>
                </div>
            </div>
                ...
                {auctions.length === 0 && !isLoading ? (
                    <Card>
                        <CardContent className="py-16 text-center">
                            ...
                            <h3 className="font-semibold mb-2">No liked auctions</h3>
                            <p className="text-muted-foreground text-sm mb-4">
                                Like auctions to save them here
                            </p>
                            <Link href="/auctions">
